...
##### Usei a linguagem HTML com organização semântica para marcar as partes do projeto do site e o CSS para estilizar e organizar os elementos das páginas, busquei respeitar os princípios de UI/UX e utilizei JQuery e JavaScript para implementação de funcionalidades do formulário, botões e carrossel.
